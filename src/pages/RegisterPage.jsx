...
export default function RegisterPage() {
  ...
  // Show "check your inbox" after registration
  if (sent) {
    return (
      <div className="min-h-screen bg-hero-pattern flex items-center justify-center px-6 py-24">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-moss/10 border border-eco-100 p-10 text-center">
          ...
          <p className="font-body text-bark/45 text-xs leading-relaxed mb-8">
            Click the link to verify your account. Once verified you can sign in
            with your password. Check spam if you don't see it.
          </p>
          <button
            ...
            <div>
              ...
              {passwordStrength && (
                <div className="mt-2">
                  ...
                  <p
                    className={`font-mono text-xs mt-1 ${passwordStrength === "weak" ? "text-red-500" : passwordStrength === "good" ? "text-yellow-600" : "text-eco-600"}`}
                  >
            ...
            <div className="bg-eco-50 border border-eco-100 rounded-2xl p-4 space-y-2">
              {[
                ...
                <div key={benefit} className="flex items-center gap-2">
                  ...
                  <span className="font-body text-xs text-bark/65">
                    {benefit}
                  </span>
                </div>
              ))}
